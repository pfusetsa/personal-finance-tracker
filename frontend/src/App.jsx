...
const PAGE_SIZE = 10;
const translations = {
  en: { financeTracker: "Finance Tracker", addTransaction: "Add Transaction", addTransfer: "Add Transfer", askAI: "Ask the AI", balanceReport: "Balance Report", totalBalance: "Total Balance", recentTransactions: "Recent Transactions", summaryByCategory: "Summary by Category", incomeVsExpenses: "Income vs. Expenses", recurrentTransactions: "Recurrent Transactions", balanceEvolution: "Balance Evolution", editTransaction: "Edit Transaction", date: "Date", description: "Description", category: "Category", recurrent: "Recurrent", amount: "Amount", actions: "Actions", income: "Income", expenses: "Expenses", both: "Both", yes: "Yes", no: "No", '6 Months': '6 Months', '1 Year': '1 Year', 'All Time': 'All Time', 'Custom': 'Custom', 'Filters': 'Filters' },
...
function App() {
  ...
  const [categoryChartType, setCategoryChartType] = useState('expense'); // New state for the filter
  ...
  const categoryChartFilterControl = (
    <select 
      ...
      <main>
        ...
        <div className="space-y-8 mt-8">
          <ChartCard 
            ...
            isOpen={cardVisibility.incomeVsExpenses} 
            onToggle={() => toggleCardVisibility('incomeVsExpenses')}
          >
            <IncomeExpenseChart data={incomeExpenseData} t={t} />
          </ChartCard>
          <ChartCard 
            title={t.summaryByCategory} 
            isOpen={cardVisibility.category} 
            onToggle={() => toggleCardVisibility('category')}
            headerControls={categoryChartFilterControl} // Pass the filter as a control
          >
            <CategoryChart data={categorySummaryData} t={t} />
          </ChartCard>
          <ChartCard 
            title={t.recurrentTransactions} 
            isOpen={cardVisibility.recurrent} 
            onToggle={() => toggleCardVisibility('recurrent')}
          >
