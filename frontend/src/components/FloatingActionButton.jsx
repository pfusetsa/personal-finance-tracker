...
function FloatingActionButton({ actions }) {
  ...
  // SVG Icons for the buttons (remain the same)
  const ICONS = {
    add: <svg xmlns="http://www.w.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" /></svg>,
