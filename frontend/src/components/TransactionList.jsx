...
function TransactionList({ transactions, onEdit, onDelete, categoryColorMap, t, filters, onFilterChange, accounts, categories, language, isFiltering }) {
            ...
            {transactions && transactions.length > 0 ? (
              ...
              <tr>
                <td colSpan="7" className="text-center py-16 px-6">
                  <h3 className="text-xl font-semibold text-gray-800">{t.noMatchingTransactions || "No transactions found"}</h3>
                  <p className="text-gray-500 mt-2">{t.noMatchingTransactionsSubtitle || "Try adjusting your filters or adding a new transaction."}</p>
                </td>
              </tr>
            )}
          </tbody>
